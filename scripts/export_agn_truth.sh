...
sqlite3 -header -csv ${SRC_FILE} "select * from truth_summary;" > ${DEST_DIR}/agn_truth_summary.csv

sqlite3 -header -csv  ${SRC_FILE} "select * from agn_auxiliary_info;" > ${DEST_DIR}/agn_auxiliary_info.csv

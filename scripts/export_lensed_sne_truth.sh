...
sqlite3 -header -csv ${SRC_FILE} "select * from truth_summary;" > ${DEST_DIR}/lensed_sne_truth_summary.csv

# variability
sqlite3 -header -csv ${SRC_FILE} "select * from lensed_sn_variability_truth;" > ${DEST_DIR}/lensed_sn_variability_truth.csv
